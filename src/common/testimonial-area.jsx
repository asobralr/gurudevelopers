...
const testimonial_content = {
  ...
  sub_title: "CLIENTS TESTIMONIALS",
  title: (
    <>
...
const TestimonialArea = () => {
  ...
  return (
    <>
      <div className="tp-testimonial-area pt-130 pb-130 fix" style={{ marginBottom: 40, position: "relative" }}>
          ...
          <div className="row g-0">
            <div className="col-12">
              <div className="tp-testimonial-five-slider-section">
                <Swiper {...setting} onSliderMove={handleSlideChange} onTransitionEnd={handleTransitionEnd} modules={[Navigation, Scrollbar]} className={`swiper-container testimonial-five-slider-active ${isDragged ? "dragged" : ""}`}>
