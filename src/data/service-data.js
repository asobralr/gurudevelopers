...
const  service_data = [
    ...
    // for home 03
    {
        ...
        icon: <ServiceIconTwo />,
        img: <ServiceIconTwo />,
        title: "React Nextjs Frontend ",
        description: <>100% responsive sites and advanced e-commerce features</>,
        delay: ".9s",
    },
    {
        id: 7,
        ...
        img: <ServiceIconOne />,
        title: "Backend",
        description: <>Managing databases and APIs for optimal performance, ensuring seamless control, and empowering your systems.</>,
        delay: ".9s",
    },
    {
        id: 8,
        ...
        title: "Design",
        description: <>Revolutionize user experiences with our expert UI/UX development. Elevate your digital presence through captivating design and seamless functionality</>,
        delay: ".9s",
    },
    {
        id: 9,
        ...
        title: "Blockchain",
        description: <>Elevate projects with our expertise in Smart Contracts and Oraculus development. Unleash the power of secure, intelligent, and efficient solutions. Let's shape the future together!</>,
        delay: ".9s",
    },
