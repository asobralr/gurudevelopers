...
const testimonial_data = [
    ...
    },
    {
        ...
        title: "r", 
        count: 59, 
        description: <> They communicate well and are eager and highly pleasant to work with. The work is thorough and they are attentive to details and the particulars of the requirements. We look forward to working with them again on future projects. Cannot recommend them enough.”</>,
        sub_des: <>We have had a wonderful experience working with Dario and his team.</>
    ...
    },
    {
        ...
        description: <>“  The results are even more than expected, he and his team are responsible and fully committed to every project we work on. They responds to changing and sometimes challenging situations, always maintaining his positive attitude and working hard to meet all agreed deadlines. Always proactive, adapts easily to changes and has a great capacity for teamwork. If I had the chance to choose, I will always choose him and his team to work on all projects. ”</>,
