...
import testimonial_img_2 from '../../public/assets/img/testimonial/testi-icon-1.jpeg'
...
const testimonial_data = [
  // for home 01
  {
    ...
    description: (
      <>
        “Business growth is a point a business reaches where it expands and
  ...
  },
  {
    ...
    description: (
      <>
        {' '}
        They communicate well and are eager and highly pleasant to work with.
        The work is thorough and they are attentive to details and the
        particulars of the requirements. We look forward to working with them
        again on future projects. Cannot recommend them enough.”
      </>
    ),
    sub_des: (
      <>We have had a wonderful experience working with Dario and his team.</>
    )
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: (
      <>
        “Market penetration. The aim of this strategy is to increase sales of
        existing products or services on existing markets, and thus to increase
        your market share.”
      </>
    ),
    sub_des: <>Increase in offline purchases versus control group.</>
...

  {
    ...
    description: (
      <>
        We have had a wonderful experience working with Dario and his team. They
        communicate well and are eager and highly pleasant to work with. The
        work is thorough and they are attentive to details and the particulars
        of the requirements. We look forward to working with them again on
        future projects. Cannot recommend them enough.
      </>
    )
  },

  {
    ...
    description: (
      <>
        “ This is really awesome. many small businessmen are suffering from this
        service in different platform and the lovers are always looking this
        kind of feature on their own website. ”
      </>
    )
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        “ The results are even more than expected, he and his team are
        responsible and fully committed to every project we work on. They
        responds to changing and sometimes challenging situations, always
        maintaining his positive attitude and working hard to meet all agreed
        deadlines. Always proactive, adapts easily to changes and has a great
        capacity for teamwork. If I had the chance to choose, I will always
        choose him and his team to work on all projects. ”
      </>
    )
  }
]
