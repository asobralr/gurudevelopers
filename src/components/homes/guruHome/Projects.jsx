    ...
    <>
      <div className="portfolio-area pt-50 pb-90">
        <div className="container">
          <h3 className="tp-section-title-3 wow tpfadeLeft" style={{ marginBottom: 50 }} data-wow-duration=".9s" data-wow-delay=".3s">
            Our Projects
          </h3>
          ...
          <div className="homeProjects_viewMore">
            <Link href="/project" className="tp-btn-blue-lg tp-btn-hover mb-10 alt-color-black wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".5s" style={{ backgroundColor: "#03357a" }}>
              <span>View More</span>
              <b></b>
            </Link>
          </div>
